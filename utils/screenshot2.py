...
class ScreenshotKeywords(object):
    ...
    @classmethod
    def capture_page_screenshot(cls):
        ...
        """
        print('capture_page_screenshotcapture_page_screenshot')
        path = self._get_screenshot_path('selenium-screenshot-{index}.png')
        print('path!!!!!')
        self.info('path!!!!!')
        print(path)
        self._create_directory(path)
        if not WebDriverManager.getdriver().save_screenshot(path):
